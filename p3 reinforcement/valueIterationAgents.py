        ...
        for k in range(self.iterations):
            ...
            for state in self.mdp.getStates():
                ...
                for action in self.mdp.getPossibleActions(state):
                    ...
                    if q_value > maxValue:
                        maxValue = q_value
                temp_counter[state] = maxValue if maxValue != -float('inf') else 0
...
class AsynchronousValueIterationAgent(ValueIterationAgent):
    ...
    def runValueIteration(self):
        """
        Here is how cyclic value iteration works.
        ...
        for k in range(self.iterations):
            ...
            state_index = state_index + 1 if state_index < len(states) - 1 else 0
    ...
    def runValueIteration(self):
        ...
        for s in self.mdp.getStates():
            ...
            for action in self.mdp.getPossibleActions(s):
                for next_state, _ in self.mdp.getTransitionStatesAndProbs(s, action):
                    if next_state in state_states:
                        state_states[next_state].add(s)
                    else:
                        state_states[next_state] = {s}
        ...
        for s in self.mdp.getStates():
            ...
            for action in self.mdp.getPossibleActions(s):
                ...
                if value > max_q_value: max_q_value = value
