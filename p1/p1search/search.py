...
"""
In p1search.py, you will implement generic p1search algorithms which are called by
...
class SearchProblem:
    """
    This class outlines the structure of a p1search problem, but doesn't implement
    ...
    def getStartState(self):
        """
        Returns the start state for the p1search problem.
        """
...
def depthFirstSearch(problem):
    """
    Search the deepest nodes in the p1search tree first.

    Your p1search algorithm needs to return a list of actions that reaches the
    goal. Make sure to implement a graph p1search algorithm.

    To get started, you might want to try some of these simple commands to
    understand the p1search problem that is being passed in:
...
def breadthFirstSearch(problem):
    """Search the shallowest nodes in the p1search tree first."""
    class Node:
        def __init__(self, state, parent, action):
